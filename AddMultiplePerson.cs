...
{
    class AddMultiplePerson
    {
        //creating the list 
        private static List<UC1Create_a_contact> contacts = new List<UC1Create_a_contact>();
        ...
        public static void EnterInput()
        {
            ...
            {
                UC1Create_a_contact details = new UC1Create_a_contact();
        ...
        public static void PrintTheDetails(UC1Create_a_contact item)
        {
